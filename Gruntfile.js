    ...
    copy: {
      ...
      dist: {
        files: [
            ...
            { src: './hmac-sha256.js', dest: 'dist-tmp/hmac-sha256.js', expand: false },
            { src: './sha256-min.js', dest: 'dist-tmp/sha256-min.js', expand: false },
            ...
            dist: {
              files: {
                'dist/elasticsearch-connector.min.js': [
                        ...
                        'dist-tmp/q*.js',          
                        'dist-tmp/sha256-min.js',
                        'dist-tmp/hmac-sha256.js',
